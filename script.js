document.addEventListener("DOMContentLoaded", () => {
  ...
  const uDict = {
    ...
    "MA'LUMOTLARNI TAHRIRLASH": ["MA'LUMOTLARNI TAHRIRLASH", "РЕДАКТИРОВАТЬ ДАННЫЕ", "EDIT DATA"],
    ...
    "Qo'llab-quvvatlash xizmati": ["Qo'llab-quvvatlash xizmati", "Служба поддержки", "Support Service"],
    "Ko'p beriladigan savollar": ["Ko'p beriladigan savollar", "Частые вопросы", "FAQ"],
    "Mening profilim": ["Mening profilim", "Мой профиль", "My Profile"],
    "Haydovchi profili": ["Haydovchi profili", "Профиль водителя", "Driver Profile"],
    ...
    "Ismingiz (masalan, Dostonbek)": ["Ismingiz (masalan, Dostonbek)", "Ваше имя (например, Достонбек)", "Your name (e.g. Dostonbek)"],
    ...
    "SOVG'ALARNI KO'RISH": ["SOVG'ALARNI KO'RISH", "ПОСМОТРЕТЬ ПОДАРКИ", "VIEW GIFTS"],
    "OPERATOR BILAN BOG'LANISH": ["OPERATOR BILAN BOG'LANISH", "СВЯЗАТЬСЯ С ОПЕРАТОРОМ", "CONTACT OPERATOR"],
    ...
    "Keyingi darajagacha 6,000 ball qoldi": ["Keyingi darajagacha 6,000 ball qoldi", "До следующего уровня осталось 6,000 баллов", "6,000 points left to next level"],
    "Hisobingizni o'chirib tashlaganingizdan so'ng,": ["Hisobingizni o'chirib tashlaganingizdan so'ng,", "После удаления аккаунта,", "After deleting your account,"],
    "barcha bonuslar va safarlar tarixi tiklanmaydigan qilib o'chiriladi.": ["barcha bonuslar va safarlar tarixi tiklanmaydigan qilib o'chiriladi.", "все бонусы и история поездок будут безвозвратно удалены.", "all bonuses and ride history will be permanently deleted."],
    ...
    "Yangi parolni kiriting": ["Yangi parolni kiriting", "Введите новый пароль", "Enter new password"],
    "Telegram bot roqali bog'lanish": ["Telegram bot orqali bog'lanish", "Связаться через Telegram бот", "Contact via Telegram bot"],
    "Karta qanday qo'shiladi?": ["Karta qanday qo'shiladi?", "Как добавить карту?", "How to add a card?"],
    "To'lov usullari bo'limidan qo'shishingiz mumkin.": ["To'lov usullari bo'limidan qo'shishingiz mumkin.", "Вы можете добавить её в разделе Способы оплаты.", "You can add it in the Payment Methods section."],
    "Kutish vaqti pullikmi?": ["Kutish vaqti pullikmi?", "Время ожидания платное?", "Is waiting time paid?"],
    "Belgilangan bepul kutish vaqtidan so'ng har bir daqiqa uchun tarif bo'yicha hisoblanadi.": ["Belgilangan bepul kutish vaqtidan so'ng har bir daqiqa uchun tarif bo'yicha hisoblanadi.", "После установленного бесплатного времени ожидания каждая минута рассчитывается по тарифу.", "After the designated free waiting time, each minute is calculated according to the tariff."],
    "Bonuslar nima uchun kerak?": ["Bonuslar nima uchun kerak?", "Зачем нужны бонусы?", "What are bonuses for?"],
    "Ularni navbatdagi safarlaringizda chegirma sifatida ishlatishingiz mumkin.": ["Ularni navbatdagi safarlaringizda chegirma sifatida ishlatishingiz mumkin.", "Вы можете использовать их как скидку на следующие поездки.", "You can use them as a discount on your next rides."],
    "Amal qilish muddati (OO/YY)": ["Amal qilish muddati (OO/YY)", "Срок действия (ММ/ГГ)", "Expiry date (MM/YY)"],
    "Karta raqami": ["Karta raqami (0000 0000 0000 0000)", "Номер карты (0000 0000 0000 0000)", "Card Number (0000 0000 0000 0000)"]
  };
